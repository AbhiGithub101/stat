...
{% embed url="https://youtu.be/r_e8Lp1ZCkw" %}
...
A program has meaning only if it interacts with the user; in simpler terms, it takes instructions from user and executes itself based on it. To understand better, let's make a simple addition program.
