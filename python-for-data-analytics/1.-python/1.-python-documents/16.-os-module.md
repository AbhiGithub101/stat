...
## &#x20;<a href="#introduction-to-os-module" id="introduction-to-os-module"></a>

{% embed url="https://youtu.be/tvAvF_JsaIY" %}

## Introduction to OS Module : <a href="#introduction-to-os-module" id="introduction-to-os-module"></a>

To use the os module in Python, we must first import it.

### Renaming File : <a href="#renaming-file" id="renaming-file"></a>

To rename a file, the rename() method is used.
...
To create a new Directory or folder, we use the mkdir() method.
...
The folder that has been created is empty by now, but we can create multiple files in it by simply creating a loop. Suppose I want to create 100 files in a folder, our code may look like this :
