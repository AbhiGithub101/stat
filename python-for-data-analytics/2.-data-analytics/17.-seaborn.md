...
### Install Seaborn - [¶](17.-seaborn.md#Install-Seaborn--)

`pip install seaborn`

### Import Libraries [¶](17.-seaborn.md#Import-Libraries)

In \[1]:

importpandasaspd importmatplotlib.pyplotasplt importseabornassns

### 1. relplot [¶](17.-seaborn.md#1.--relplot)
...
### Segmentation - style [¶](17.-seaborn.md#Segmentation---style)
...
### Segmentation - row [¶](17.-seaborn.md#Segmentation---row)
...
### Segmentation - col [¶](17.-seaborn.md#Segmentation---col)
...
### 2. relplot - line [¶](17.-seaborn.md#2.-relplot---line)
...
#### An Example : [¶](17.-seaborn.md#An-Example--:)
...
#### Let's Explore With Examples [¶](17.-seaborn.md#Let's-Explore-With-Examples)
...
#### Yearly Average Sales [¶](17.-seaborn.md#Yearly-Average-Sales)
...
#### Total Sales [¶](17.-seaborn.md#Total-Sales)
...
## 📊 Correlation Heatmap — Notebook Explanation [¶](17.-seaborn.md#%F0%9F%93%8A-Correlation-Heatmap-%E2%80%94-Notebook-Explanation)

### 📌 What is Correlation? [¶](17.-seaborn.md#%F0%9F%93%8C-What-is-Correlation?)
...
### 📌 What is a Correlation Heatmap? [¶](17.-seaborn.md#%F0%9F%93%8C-What-is-a-Correlation-Heatmap?)
...
### 🎨 How to Read Colors in a Correlation Heatmap [¶](17.-seaborn.md#%F0%9F%8E%A8-How-to-Read-Colors-in-a-Correlation-Heatmap)
...
### 📌 Why Use a Correlation Heatmap? [¶](17.-seaborn.md#%F0%9F%93%8C-Why-Use-a-Correlation-Heatmap?)
...
### 📌 Example Interpretation [¶](17.-seaborn.md#%F0%9F%93%8C-Example-Interpretation)
...
### 🧠 Key Takeaway [¶](17.-seaborn.md#%F0%9F%A7%A0-Key-Takeaway)
...
### regression - lmplot [¶](17.-seaborn.md#regression---lmplot)
