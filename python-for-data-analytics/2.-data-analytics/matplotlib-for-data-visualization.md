...
{% file src="../../.gitbook/assets/Adidas US Sales Datasets (1).xlsx" %}

{% file src="../../.gitbook/assets/Sleep_health_and_lifestyle_dataset (1).csv" %}
...
2. Using the lists\
   ...
   Plot both in the **same scatter plot** with a legend.
...
7. Plot:\
   `month = ['jan','feb','mar','apr']`\
   `sale = [100,200,50,400]`\
   Add a small written conclusion.
...
2. Using:
   ...
   * `tea = [...]`
   * `ice = [...]`\
     Plot three scatter plots in one figure (subplot method).
