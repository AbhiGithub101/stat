...
```py
pip install pandas # Run this command in your terminal to install pandas
```
...
```python
import pandas as pd
data = pd.read_excel(r"C:\Users\nigam\Desktop\Adidas US Sales Datasets.xlsx")# Use your own path for loading the dataset
data
```
...
```python
# First insert two empty rows in your excel file
skip_data=pd.read_excel('Adidas US Sales Datasets.xlsx',skiprows=2)
skip_data
```

</details>

5. Delete Header and load the data with new headers using names parameter.
...
```python
second_sheet=pd.read_excel('Adidas US Sales Datasets.xlsx', sheet_name='Sheet1')
second_sheet
```
