...
<p align="center">Sales Dashboard<br>↓<br>Search in the title bar <br>↓<br>Click on View Option<br>↓<br>Select Filters, Bookmarks, and Selection<br>↓<br>Select any Data on any Visuals<br>↓<br>Go to Bookmarks<br>↓<br>Click on Add option<br>↓<br>Rename the tab name<br>(My Employees)<br>↓<br>Click on "My Employees" Bookmark<br>↓<br>Applies to the Current page<br>(Sales Dashboard)<br></p>
