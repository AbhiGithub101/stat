...
# 6. Build Your First AI Document Summarizer with LangChain
...
{% embed url="https://youtu.be/0i-oK3Wzcxk?si=AYkma1egd3ipWAj4" %}
...
{% content-ref url="7.-running-the-document-summarization-chain.md" %}
[7.-running-the-document-summarization-chain.md](7.-running-the-document-summarization-chain.md)
{% endcontent-ref %}
